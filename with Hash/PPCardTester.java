...
class PPCardTester {
	...
	public static void newCardTest(float iniBal, String name, int actNum, int authNum) {
		cardNum++;
		totalcards++;
	...
	public static void main(String args[]) {
		...
		// iniBal name acctNum authCode
		newCardTest(100, "Bob Vance", 123, 123);
		newCardTest(150, "Dave Heard", 321, 321);
		newCardTest(1000, "Paul Jones", 456, 456);
		newCardTest(300, "Kyle Hunt", 465, 465);
		newCardTest(450, "Sam Green", 789, 789);
		newCardTest(500, "Dennis Smith", 978, 978);
